 ...
 */
public class ArticleAllDao extends DataDao {

    private static final String TAG = "ArticleAllDao";
    protected static final String TAB_NAME = "ArticleAll";

    public ArticleAllDao(Context context) {
        super(context);
        createTable();
    }
    ...
    public void addActionResult(List<Article> articleList) {
